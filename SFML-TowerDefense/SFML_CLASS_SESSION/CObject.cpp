...
void CObject::SetTexture(std::string _FilePath)
{
	...
	m_ObjectShape.setTextureRect(sf::IntRect(	m_ObjectShape.getGlobalBounds().left, 
												m_ObjectShape.getGlobalBounds().top,
												m_ObjectShape.getGlobalBounds().width,
												m_ObjectShape.getGlobalBounds().height));//this is the best layout of this i could find lmao
}
